...
4. **`.claude/agents/*.md`** — copies of all 14 plugin agents into the project (avoids shadowing issues)
...
- `.claude/agents/` — 14 agent files installed
